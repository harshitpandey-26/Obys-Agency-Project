...
function cursorAnimation() {
  ...
  function handleMouseMove(dets) {
    gsap.to(".crsr", {
      opacity: 0,
      overwrite: "auto", // Ensures previous animations are canceled
    });

    gsap.to(".video-cursor", {
      left: dets.x - 500,
      top: dets.y - 300,
      overwrite: "auto", // Cancels the previous animation if still in progress
    });
  }
  ...
  videoContainer.addEventListener("mouseleave", function () {
    ...
    // Remove the mousemove listener to stop unnecessary animation
